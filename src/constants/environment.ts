...
export const GCP_ABIs = {
    ChatterPayWallet:
        'https://storage.googleapis.com/chatbot-multimedia/chatterpay/ABIs/ChatterPayWallet.json',
    ChatterPayWalletFactory:
        'https://storage.googleapis.com/chatbot-multimedia/chatterpay/ABIs/ChatterPayWalletFactory.json',
    ChatterPayNFT:
        'https://storage.googleapis.com/chatbot-multimedia/chatterpay/ABIs/ChatterPayNFT.json',
