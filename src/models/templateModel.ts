...
export enum NotificationEnum {
  ...
  polymarket_terms_request = 'polymarket_terms_request',
  ...
  cardano_fee_price_unavailable = 'cardano_fee_price_unavailable',
...
const templateSchema = new Schema<ITemplateSchema>({
  notifications: {
    ...
    polymarket_terms_request: { type: notificationSchema, required: false },
    ...
    cardano_fee_price_unavailable: { type: notificationSchema, required: false },
