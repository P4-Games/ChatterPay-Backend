...
tokenWhitelistSchema.pre('save', function(next) {
  this.updatedAt = new Date();
  next();
});

export const TokenWhitelistModel = model<ITokenWhitelist>('TokenWhitelist', tokenWhitelistSchema, 'token_whitelist');
