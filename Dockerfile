...
ARG CARDANO_SPONSOR_DERIVATION_CHECK
ARG CARDANO_STAKING_SYNC_SECRET
ARG CARDANO_STAKING_FRONTEND_BFF_SECRET
...
ENV CARDANO_SPONSOR_DERIVATION_CHECK $CARDANO_SPONSOR_DERIVATION_CHECK
ENV CARDANO_STAKING_SYNC_SECRET $CARDANO_STAKING_SYNC_SECRET
ENV CARDANO_STAKING_FRONTEND_BFF_SECRET $CARDANO_STAKING_FRONTEND_BFF_SECRET
