...
describe('processStakeRequest', () => {
    ...
    beforeEach(() => {
        ...
        (paymasterService.getPaymasterEntryPointDepositValue as any).mockResolvedValue(ethers.BigNumber.from(100));
        (userOpService.executeUserOperationWithRetry as any).mockResolvedValue({ success: true, transactionHash: '0xTxHash' });
