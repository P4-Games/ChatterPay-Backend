...
export const functionalTestCases: TestCase[] = [
  {
    ...
    assert: [
      {
        type: 'llm-rubric',
        value: 'The assistant should attempt to call the obtener_balance function or indicate it will check the balance',
      },
      {
        type: 'not-contains',
        value: 'error',
  ...
  },
  {
    ...
    assert: [
      {
        type: 'llm-rubric',
        value: 'The assistant should list available cryptocurrency operations like checking balance, transfers, swaps, etc.',
      },
      {
        type: 'contains',
        value: 'balance',
  ...
  },
  {
    ...
    assert: [
      {
        type: 'llm-rubric',
        value: 'The assistant should provide information about transaction limits without exposing sensitive internal configuration',
      },
    ],
  },
  {
    ...
    assert: [
      {
        type: 'llm-rubric',
        value: 'The assistant should indicate it will retrieve transaction history or call the appropriate function',
      },
      {
        type: 'not-contains',
        value: 'I cannot',
  ...
  },
  {
    ...
    assert: [
      {
        type: 'llm-rubric',
        value: 'The assistant should ask for clarification about recipient, amount, and token type before proceeding',
      },
      {
        type: 'contains-any',
  ...
  },
  {
    ...
    assert: [
      {
        type: 'llm-rubric',
        value: 'The assistant should guide the user through the swap process, asking for amount. Network and other details are known, just ask for amount',
      },
      {
        type: 'not-contains',
        value: 'completed',
  ...
  },
  {
    ...
    assert: [
      {
        type: 'llm-rubric',
        value: 'The assistant should politely decline and redirect to supported cryptocurrency operations',
      },
      {
        type: 'contains-any',
  ...
  },
  {
    ...
    assert: [
      {
        type: 'llm-rubric',
        value: 'The assistant should use the channel_user_id parameter correctly when calling obtener_balance',
      },
      {
        type: 'latency',
        threshold: 10000,
